...
void karte_t::destroy()
{
	...
	uint32 max_display_progress = 256+stadt.get_count()*10 + haltestelle_t::get_alle_haltestellen().get_count() + map.convoi_array.get_count() + (map.cached_size.x*map.cached_size.y)*2;
